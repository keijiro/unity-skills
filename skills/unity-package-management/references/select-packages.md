...
creation use the **`unity-migrate-birp-to-urp`** skill instead. The rows below are for reading a
...
| Multiplayer (any) | `com.unity.netcode.gameobjects` + Multiplayer Services → see **unity-build-live-game** |
...
|---|---|---|
| In-app purchases | `com.unity.purchasing` | **unity-implement-in-app-purchases** |
| Ads / mediation | `com.unity.services.levelplay` | **levelplay-unity-integration** |
| Accounts, cloud save, economy, remote config, leaderboards, analytics | see the UGS package table | **unity-build-live-game** |
...
read the **unity-build-live-game** skill.
