...
/// <summary>
/// Creates RuleTile TilingRules by first applying unity-sprite-segment-3x3grid analysis,
...
public static class TilemapRuleTileCreateFromSegment
{
    ...
    /// <summary>
    /// Creates a RuleTile from sprites by first running unity-sprite-segment-3x3grid analysis.
    ...
    /// <param name="matchThreshold">Match threshold for unity-sprite-segment-3x3grid (0.5, 0.75, or 0.9)</param>
    /// <param name="colorTolerance">Color tolerance for unity-sprite-segment-3x3grid</param>
        ...
        bool filterToKnownPatterns = true)
    {
        ...
        {
            // Step 1: Always run unity-sprite-segment-3x3grid first
    ...
    /// <summary>
    /// Creates a single TilingRule from a unity-sprite-segment-3x3grid output pattern.
    /// </summary>
    /// <param name="pattern">Pattern string from unity-sprite-segment-3x3grid, e.g., "X X X / X * X / . . ."</param>
    ...
    /// <summary>
    /// Parses a unity-sprite-segment-3x3grid output pattern into an array of 9 cell values.
    /// </summary>
